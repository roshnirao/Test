 ...
 */
public class listintraevedetails extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listintraevedet);
...
fin=msg.split("~");
    ...
    class DownloadFileAsync4 extends AsyncTask<String, String, String> {
        ...
        final Intent i = new Intent(listintraevedetails.this,imgdis.class);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(listintraevedetails.this, "", "Checking the image existance...");
        ...
        protected void onPostExecute(String unused) {
            ...
            if(checks.equals("no")){
                AlertDialog alertDialog = new AlertDialog.Builder(listintraevedetails.this).create();
