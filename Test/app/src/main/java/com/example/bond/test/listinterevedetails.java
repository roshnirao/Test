 ...
 */
public class listinterevedetails extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listinterevedet);

        t35=(TextView)findViewById(R.id.textView40);
        t36=(TextView)findViewById(R.id.textView41);
    ...
    class DownloadFileAsync4 extends AsyncTask<String, String, String> {
        ...
        final Intent i = new Intent(listinterevedetails.this,imgdis.class);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(listinterevedetails.this, "", "Checking the image existance...");
        ...
        protected void onPostExecute(String unused) {
            ...
            if(checks.equals("no")){
                AlertDialog alertDialog = new AlertDialog.Builder(listinterevedetails.this).create();
